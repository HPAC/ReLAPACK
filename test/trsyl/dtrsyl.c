...
int main(int argc, char* argv[]) {
    ...
    // N N +1 m = n
    {
        ...
        BLAS(dscal)(&mm1, s0, A1 + 1, &mp1);
        BLAS(dscal)(&mm1, s0, A2 + 1, &mp1);
        BLAS(dscal)(&nm1, s0, B1 + 1, &np1);
        BLAS(dscal)(&nm1, s0, B2 + 1, &np1);
    ...
    { // N N +1 m < n
        ...
        // apply scales
        LAPACK(dlascl)("G", i0, i0, s1, &scale1, &m, &n, C2, &m, &info);
        LAPACK(dlascl)("G", i0, i0, s1, &scale2, &m, &n, C1, &m, &info);
