...
static void RELAPACK(ssygst_rec)(
    ...
    // recursion(A_TL, B_TL)
    RELAPACK(ssygst_rec)(itype, uplo, &n1, A_TL, ldA, B_TL, ldB, Work, lWork, info);
    ...
    // recursion(A_BR, B_BR)
    RELAPACK(ssygst_rec)(itype, uplo, &n2, A_BR, ldA, B_BR, ldB, Work, lWork, info);
}
