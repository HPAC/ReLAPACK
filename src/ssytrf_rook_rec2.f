* SSYTRF_ROOK_REC2 computes a partial factorization of a real symmetric matrix using the bounded Bunch-Kaufman ("rook") diagonal pivoting method.
*
...
* recursive algorithm.
      SUBROUTINE RELAPACK_SSYTRF_ROOK_REC2( UPLO, N, NB, KB, A, LDA,
     $                                      IPIV, W, LDW, INFO )
      CHARACTER          UPLO
