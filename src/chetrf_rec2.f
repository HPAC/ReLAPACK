*> \brief \b CHETRF_REC2 computes a partial factorization of a complex Hermitian indefinite matrix using the Bunch-Kaufman diagonal pivoting method (blocked algorithm, calling Level 3 BLAS).
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE CHETRF_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> CHETRF_REC2 computes a partial factorization of a complex Hermitian
...
*>
*> CHETRF_REC2 is an auxiliary routine called by CHETRF. It uses blocked code
