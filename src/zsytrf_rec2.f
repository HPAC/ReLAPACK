*> \brief \b ZSYTRF_REC2 computes a partial factorization of a complex symmetric matrix using the Bunch-Kaufman diagonal pivoting method.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE ZSYTRF_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> ZSYTRF_REC2 computes a partial factorization of a complex symmetric matrix
...
*>
*> ZSYTRF_REC2 is an auxiliary routine called by ZSYTRF. It uses blocked code
...
*
*  =====================================================================
      SUBROUTINE ZSYTRF_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW,
     $                        INFO )
*
