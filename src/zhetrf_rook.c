...
void RELAPACK(zhetrf_rook_rec)(const char *, const int *, const int *, int *,
...
void RELAPACK(zhetrf_rook)(
    ...
    *info = 0;
    ...
    int nout;
    RELAPACK(zhetrf_rook_rec)(&cleanuplo, n, n, &nout, A, ldA, ipiv, cleanWork, n, info);
...
static void RELAPACK(zhetrf_rook_rec)(
    ...
    if (*n <= MAX(CROSSOVER_ZHETRF_ROOK, 3)) {
        ...
        if (top) {
            ...
            *n_out = *n;
            ...
            LAPACK(zhetrf_rook_rec2)(uplo, n_full, n, n_out, A, ldA, ipiv, Work, ldWork, info);
        return;
    }
    ...
    if (*uplo == 'L') {
        ...
        // recursion(A_L)
        int n1_out;
        RELAPACK(zhetrf_rook_rec)(uplo, n_full, &n1, &n1_out, A, ldA, ipiv, Work_L, ldWork, &info1);
        n1 = n1_out;
        ...
        // recursion(A_BR)
        int n2_out;
        RELAPACK(zhetrf_rook_rec)(uplo, &n_full2, &n2, &n2_out, A_BR, ldA, ipiv_B, Work_BR, &ldWork_BR, &info2);
        ...
        *n_out = n1 + n2;
        ...
        // recursion(A_R)
        int n2_out;
        RELAPACK(zhetrf_rook_rec)(uplo, n_full, &n2, &n2_out, A, ldA, ipiv, Work_R, ldWork, &info2);
        ...
        // recursion(A_TL)
        int n1_out;
        RELAPACK(zhetrf_rook_rec)(uplo, &n_full1, &n1, &n1_out, A, ldA, ipiv, Work_L, &ldWork_L, &info1);
