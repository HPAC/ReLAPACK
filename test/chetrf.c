...
int main(int argc, char* argv[]) {
    ...
    { // L
        ...
        // run
        RELAPACK(chetrf)("L", &n, A1, &n, ipiv1, Work, &lWork, &info);
        LAPACK(chetf2)("L", &n, A2, &n, ipiv2, &info);
    ...
    { // U
        ...
        // run
        RELAPACK(chetrf)("U", &n, A1, &n, ipiv1, Work, &lWork, &info);
        LAPACK(chetf2)("U", &n, A2, &n, ipiv2, &info);
