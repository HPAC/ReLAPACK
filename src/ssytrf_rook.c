...
void RELAPACK(ssytrf_rook_rec)(const char *, const int *, const int *, int *,
...
void RELAPACK(ssytrf_rook)(
    ...
    *info = 0;
    ...
    int nout;
    RELAPACK(ssytrf_rook_rec)(&cleanuplo, n, n, &nout, A, ldA, ipiv, cleanWork, n, info);
...
static void RELAPACK(ssytrf_rook_rec)(
    ...
    if (*n <= MAX(CROSSOVER_SSYTRF_ROOK, 3)) {
        ...
        if (top) {
            ...
            *n_out = *n;
            ...
            LAPACK(ssytrf_rook_rec2)(uplo, n_full, n, n_out, A, ldA, ipiv, Work, ldWork, info);
        return;
    }
    ...
    if (*uplo == 'L') {
        ...
        // recursion(A_L)
        int n1_out;
        RELAPACK(ssytrf_rook_rec)(uplo, n_full, &n1, &n1_out, A, ldA, ipiv, Work_L, ldWork, &info1);
        n1 = n1_out;
        ...
        RELAPACK(sgemm_tr_rec)("N", "T", uplo, &n2, &n1, MONE, A_BL, ldA, Work_BL, ldWork, ONE, A_BR, ldA);
        BLAS(sgemm)("N", "T", &n_rest, &n2, &n1, MONE, A_BL_B, ldA, Work_BL, ldWork, ONE, A_BR_B, ldA);

        // recursion(A_BR)
        int n2_out;
        RELAPACK(ssytrf_rook_rec)(uplo, &n_full2, &n2, &n2_out, A_BR, ldA, ipiv_B, Work_BR, &ldWork_BR, &info2);
        ...
        *n_out = n1 + n2;
        ...
        // recursion(A_R)
        int n2_out;
        RELAPACK(ssytrf_rook_rec)(uplo, n_full, &n2, &n2_out, A, ldA, ipiv, Work_R, ldWork, &info2);
        ...
        RELAPACK(sgemm_tr_rec)("N", "T", uplo, &n1, &n2, MONE, A_TR, ldA, Work_TR, ldWork, ONE, A_TL, ldA);
        BLAS(sgemm)("N", "T", &n_rest, &n1, &n2, MONE, A_TR_T, ldA, Work_TR, ldWork, ONE, A_TL_T, ldA);

        // recursion(A_TL)
        int n1_out;
        RELAPACK(ssytrf_rook_rec)(uplo, &n_full1, &n1, &n1_out, A, ldA, ipiv, Work_L, &ldWork_L, &info1);
