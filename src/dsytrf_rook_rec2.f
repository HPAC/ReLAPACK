*> \brief \b DSYTRF_ROOK_REC2 computes a partial factorization of a real symmetric matrix using the bounded Bunch-Kaufman ("rook") diagonal pivoting method.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE DSYTRF_ROOK_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARADLATER          UPLO
...
*> \verbatim
*>
*> DSYTRF_ROOK_REC2 computes a partial factorization of a real symmetric
...
*>
*> DSYTRF_ROOK_REC2 is an auxiliary routine called by DSYTRF_ROOK. It uses
