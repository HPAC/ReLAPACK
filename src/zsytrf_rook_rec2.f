*> \brief \b ZSYTRF_ROOK_REC2 computes a partial factorization of a complex symmetric matrix using the bounded Bunch-Kaufman ("rook") diagonal pivoting method.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE ZSYTRF_ROOK_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> ZSYTRF_ROOK_REC2 computes a partial factorization of a complex symmetric
...
*>
*> ZSYTRF_ROOK_REC2 is an auxiliary routine called by ZSYTRF_ROOK. It uses
...
*
*  =====================================================================
      SUBROUTINE ZSYTRF_ROOK_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W,
     $                             LDW, INFO )
*
