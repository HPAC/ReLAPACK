* \brief \b ZHETRF_ROOK_REC2 computes a partial factorization of a complex Hermitian indefinite matrix using the bounded Bunch-Kaufman ("rook") diagonal pivoting method (blocked algorithm, calling Level 3 BLAS).
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE ZHETRF_ROOK_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> ZHETRF_ROOK_REC2 computes a partial factorization of a complex Hermitian
...
*>
*> ZHETRF_ROOK_REC2 is an auxiliary routine called by ZHETRF_ROOK. It uses
