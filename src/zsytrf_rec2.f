** ZSYTRF_REC2 computes a partial factorization of a complex symmetric matrix using the Bunch-Kaufman diagonal pivoting method.
*
...
* recursive algorithm.
      SUBROUTINE RELAPACK_ZSYTRF_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W,
     $                                 LDW, INFO )
      CHARACTER          UPLO
