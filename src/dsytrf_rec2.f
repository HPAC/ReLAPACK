*> \brief \b DSYTRF_REC2 computes a partial factorization of a real symmetric matrix using the Bunch-Kaufman diagonal pivoting method.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE DSYTRF_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> DSYTRF_REC2 computes a partial factorization of a real symmetric matrix A
...
*>
*> DSYTRF_REC2 is an auxiliary routine called by DSYTRF. It uses blocked code
...
*
*  =====================================================================
      SUBROUTINE DSYTRF_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW,
     $                        INFO )
*
