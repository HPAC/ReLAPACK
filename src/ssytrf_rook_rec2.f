*> \brief \b SSYTRF_ROOK_REC2 computes a partial factorization of a real symmetric matrix using the bounded Bunch-Kaufman ("rook") diagonal pivoting method.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE SSYTRF_ROOK_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> SSYTRF_ROOK_REC2 computes a partial factorization of a real symmetric
...
*>
*> SSYTRF_ROOK_REC2 is an auxiliary routine called by SSYTRF_ROOK. It uses
...
*
*  =====================================================================
      SUBROUTINE SSYTRF_ROOK_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W,
     $                             LDW, INFO )
*
