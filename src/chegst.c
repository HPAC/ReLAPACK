...
void RELAPACK(chegst)(const int *itype, const char *uplo, const int *n,
    ...
    *info = 0;
    ...
    // recursion(A_TL, B_TL)
    RELAPACK(chegst)(itype, uplo, &n1, A_TL, ldA, B_TL, ldB, info);
    ...
    // recursion(A_BR, B_BR)
    RELAPACK(chegst)(itype, uplo, &n2, A_BR, ldA, B_BR, ldB, info);
}
