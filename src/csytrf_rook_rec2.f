*> \brief \b CSYTRF_ROOK_REC2 computes a partial factorization of a complex symmetric matrix using the bounded Bunch-Kaufman ("rook") diagonal pivoting method.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE CSYTRF_ROOK_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> CSYTRF_ROOK_REC2 computes a partial factorization of a complex symmetric
...
*>
*> CSYTRF_ROOK_REC2 is an auxiliary routine called by CSYTRF_ROOK. It uses
...
*
*  =====================================================================
      SUBROUTINE CSYTRF_ROOK_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W,
     $                             LDW, INFO )
*
