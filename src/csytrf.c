...
void RELAPACK(csytrf_rec)(const char *, const int *, const int *, int *,
...
void RELAPACK(csytrf_rec)(
    ...
    if (*uplo == 'L') {
        ...
        // recursion(A_BR)
        int n2_out;
        RELAPACK(csytrf_rec)(uplo, &n_full2, &n2, &n2_out, A_BR, ldA, ipiv_B, Work_BR, &ldWork_BR, &info2);
        ...
        *n_out = n1 + n2;
        ...
        // recursion(A_TL)
        int n1_out;
        RELAPACK(csytrf_rec)(uplo, &n_full1, &n1, &n1_out, A, ldA, ipiv, Work_L, &ldWork_L, &info1);
