*> \brief \b CSYTRF_REC2 computes a partial factorization of a complex symmetric matrix using the Bunch-Kaufman diagonal pivoting method.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE CSYTRF_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> CSYTRF_REC2 computes a partial factorization of a complex symmetric matrix
...
*>
*> CSYTRF_REC2 is an auxiliary routine called by CSYTRF. It uses blocked code
...
*
*  =====================================================================
      SUBROUTINE CSYTRF_REC2( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW,
     $                        INFO )
*
